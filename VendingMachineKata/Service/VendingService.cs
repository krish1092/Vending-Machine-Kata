...
namespace VendingMachineKata.Service
{
    public class VendingService
    {
        ...
        private static Dictionary<double, int> coinValues = new Dictionary<double, int> { { 0.25 , 10}, { 0.10 , 10}, { 0.05 , 10} };
        

        //The algorithm goes from quarters to nickels. Tries to give as many quarters,dimes, nickels(in this order) as possible
        public double TenderChange(double RemainingAmount){
        ...
        public void AddToExistingChange(double[] coinsInserted)
        {
